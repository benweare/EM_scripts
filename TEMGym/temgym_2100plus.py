...
def show_rays_only(model, name = 'model.svg', component_lw = 4, edge_lw = 1, label_fontsize = 20, **kwargs):
    '''
    ...
    for component in model.components:
        ...
        if component.type == 'Biprism':
            ...
            if component.name == 'OL2':
              # BFP.
              ax.hlines( (component.z + component.f), -component.radius, component.radius, linestyles='dashed', color='red' )
              # Image plane.
              #ax.hlines( (1/(1/component[7].z - 1/component.f)), -component.radius, component.radius, linestyles='dashed', color='green' )
